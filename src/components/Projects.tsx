import phpproject from '../assets/Screenshot 2024-04-11 204131.png';
...
const Projects: React.FC = () => {
  const projectData = [
    {
      ...
      livePreview: 'https://ape-armor.vercel.app/',
      description: 'Your all-in-one solution for efficiently creating some cool custom back case for your iPhone.',
    ...
    },
    {
      ...
      livePreview: 'https://yourlivepreview.com/project2',
  ...
  return (
    <section className="relative flex flex-col items-center px-6 py-16 pb-16 font-sans text-sm font-light bg-black rounded-xl gap-9 md:pb-24 lg:gap-14 lg:pb-32">
              ...
              <div className="flex gap-2">
                ...
                <div className="bg-black hover:bg-black/70 flex gap-2 items-center text-white w-fit px-3 py-1.5 rounded-md text-xs">
                  <a target="_blank" className="flex gap-2" href={project.github}>
                    <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 640 512" height="16" width="16" xmlns="http://www.w3.org/2000/svg">
